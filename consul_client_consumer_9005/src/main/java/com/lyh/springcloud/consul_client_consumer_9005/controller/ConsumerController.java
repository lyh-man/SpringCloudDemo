package com.lyh.springcloud.consul_client_consumer_9005.controller;

import com.lyh.springcloud.common.tools.Result;
import com.lyh.springcloud.consul_client_consumer_9005.entity.User;
...
//    public static final String PRODUCER_URL = "http://localhost:8001/producer/";
    // 通过服务名 找到  consul 注册中心真实访问的 地址
    public static final String PRODUCER_URL = "http://consul-client-producer";
